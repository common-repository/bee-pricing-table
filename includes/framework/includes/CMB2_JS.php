...
class CMB2_JS {
	...
	public static function enqueue() {
		...
		if ( isset( $dependencies['jquery-ui-datetimepicker'] ) ) {
			wp_register_script( 'jquery-ui-datetimepicker', cmb2_utils()->url( 'js/jquery-ui-timepicker-addon.min.js' ), array( 'jquery-ui-classi' ), CMB2_VERSION );
		}
	...
	protected static function colorpicker_frontend() {
		wp_register_script( 'iris', admin_url( 'js/iris.min.js' ), array( 'jquery-ui-draggable', 'jquery-ui-classi', 'jquery-touch-punch' ), CMB2_VERSION );
	...
	protected static function localize( $debug ) {
		$l10n = array(
			...
			'script_debug'     => $debug,
			'up_arrow_class'   => 'dashicons dashicons-arrow-left-alt2',
			'down_arrow_class' => 'dashicons dashicons-arrow-right-alt2',
			'defaults'         => array(
				'color_picker' => false,
				'date_picker'  => array(
					'changeMonth'     => true,
